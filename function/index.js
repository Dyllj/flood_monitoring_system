 ...
 exports.logDeviceReadings = onValueWritten(
  ...
  async (event) => {
    ...
    try {
      ...
      // 🔍 Get the latest log
      const latestLogSnap = await logsRef
      ...
      if (!latestLogSnap.empty) {
        ...
        // 🕒 Only log if 1 minute (60,000 ms) has passed
      ...
      if (shouldLog) {
        ...
        console.log(`⏸ Skipped logging for ${sensorId} (less than 1 minute since last log)`);
      }

      // Update main device doc (always)
