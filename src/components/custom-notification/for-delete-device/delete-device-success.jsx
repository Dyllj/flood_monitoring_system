...
const DeleteDeviceSuccess = ({ onClose }) => {
  return (
    <StyledWrapper>
      <div className="card">
        ...
        <div className="message-text-container">
          <p className="message-text">Device deleted successfully!</p>
          <p className="sub-text">Device removed from database</p>
        </div>
...
export default DeleteDeviceSuccess;