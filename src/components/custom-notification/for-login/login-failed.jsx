    ...
    <StyledWrapper>
      <div className="card">
        ...
        <div className="message-text-container">
          <p className="message-text">Login failed!</p>
          <p className="sub-text">Invalid credentials or not authorized</p>
        </div>
