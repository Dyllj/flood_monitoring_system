...
const AutoSmsAlertSuccess = ({ sensorName, onClose }) => {
  return (
    <StyledWrapper>
      <div className="card">
        ...
        <div className="message-text-container">
          <p className="message-text">Auto SMS alert sent successfully!</p>
          <p className="sub-text">
            Flood alert sent automatically for {sensorName}! Authorized personnel has been notified!
          </p>
        </div>
...
export default AutoSmsAlertSuccess;
