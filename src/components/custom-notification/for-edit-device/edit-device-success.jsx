...
const EditDeviceSuccess = ({ onClose }) => {
  return (
    <StyledWrapper>
      <div className="card">
        ...
        <div className="message-text-container">
          <p className="message-text">Device updated successfully!</p>
          <p className="sub-text">Changes saved to database</p>
        </div>
...
export default EditDeviceSuccess;