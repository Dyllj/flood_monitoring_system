...
const MessageEditedSuccess = ({ onClose }) => {
  return (
    <StyledWrapper>
      <div className="card">
        ...
        <div className="message-text-container">
          <p className="message-text">Alert template saved!</p>
          <p className="sub-text">SMS notification template updated</p>
        </div>
...
export default MessageEditedSuccess;
