...
const GenerateReportHistoricalData = ({ onClose }) => {
  return (
    <StyledWrapper>
      <div className="card">
        ...
        <div className="message-text-container">
          <p className="message-text">Report generated successfully!</p>
          <p className="sub-text">MDRRMO historical data report downloaded</p>
        </div>
...
export default GenerateReportHistoricalData;
