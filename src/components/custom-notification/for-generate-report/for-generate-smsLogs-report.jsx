...
const SmsLogsReportSuccess = ({ onClose }) => {
  return (
    <StyledWrapper>
      <div className="card">
        ...
        <div className="message-text-container">
          <p className="message-text">SMS Logs report generated!</p>
          <p className="sub-text">Alert logs exported successfully</p>
        </div>
...
export default SmsLogsReportSuccess;